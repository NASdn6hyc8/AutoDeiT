...
def get_args_parser():
    parser = argparse.ArgumentParser('AutoDeiT training and evaluation script', add_help=False)
    ...
    parser.add_argument('--teacher_model_1', default='regnety_160', type=str,
                        help='Name of teacher model to train')
    parser.add_argument('--teacher_model_2', default='regnety_320', type=str,
                        help='Name of teacher model to train')
    ...
    parser.add_argument('--model', default='', type=str, metavar='MODEL',
                        help='Name of model to train')
    # AutoDeiT config
    parser.add_argument('--mode', type=str, default='super', choices=['super', 'retrain'], help='mode of AutoDeiT')
    ...
    parser.add_argument('--data-path', default='./data/imagenet/', type=str,
                        help='dataset path')
    parser.add_argument('--data-set', default='IMNET', choices=['CIFAR', 'IMNET', 'INAT', 'INAT19','CIFAR10','CIFAR100'],
...
def main(args):
    ...
    if args.teacher_model:
        ...
        if args.teacher_model_1:
            print('create teacher_model_1')
            teacher_model_1 = create_model(
                args.teacher_model_1,
                pretrained=True,
                num_classes=args.nb_classes,
            )
        ...
        if args.teacher_model_2:
            print('create teacher_model_2')
            teacher_model_2 = create_model(
                args.teacher_model_2,
                pretrained=True,
                num_classes=args.nb_classes,
            )
    ...
    if args.mode == 'retrain' and "RETRAIN" in cfg:
        retrain_config = {'layer_num': cfg.RETRAIN.DEPTH, 'embed_dim': [cfg.RETRAIN.EMBED_DIM]*cfg.RETRAIN.DEPTH,
                          'num_heads': cfg.RETRAIN.NUM_HEADS,'mlp_ratio': cfg.RETRAIN.MLP_RATIO,'dist_choice':cfg.RETRAIN.DIST_CHOICE}
    if args.eval:
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats = train_one_epoch(
            ...
            amp=args.amp, teacher_model=teacher_model,teacher_model_1=teacher_model_1,teacher_model_2=teacher_model_2,
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('AutoDeiT training and evaluation script', parents=[get_args_parser()])
